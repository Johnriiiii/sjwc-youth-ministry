...
messageRoutes.post('/messages', requireAuth, async (req, res) => {
    try {
...
messageRoutes.get('/messages', requireAuth, async (req, res) => {
    try {
...
messageRoutes.get('/messages/admin/sent', requireAuth, async (req, res) => {
    try {
        const userId = req.auth?.sub;
        if (!userId) {
            return res.status(401).json({ message: 'Unauthorized' });
...
messageRoutes.patch('/messages/:messageId/read', requireAuth, async (req, res) => {
    try {
        const authId = req.auth?.sub;
        if (!authId) {
            return res.status(401).json({ message: 'Unauthorized' });
...
messageRoutes.delete('/messages/:messageId', requireAuth, async (req, res) => {
    try {
        const authId = req.auth?.sub;
        if (!authId) {
            return res.status(401).json({ message: 'Unauthorized' });
...
messageRoutes.get('/messages/recipients/all', requireAuth, async (req, res) => {
    try {
        const userId = req.auth?.sub;
        if (!userId) {
            return res.status(401).json({ message: 'Unauthorized' });
